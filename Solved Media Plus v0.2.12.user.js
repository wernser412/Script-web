// ==UserScript==
// @name         Solved Media Plus
// @icon         https://icons.duckduckgo.com/ip2/solvemedia.com.ico
// @version      0.2.12
// @namespace    https://greasyfork.org/users/592063
// @description  Auto-Solve Media image CAPTCHAs, Plus edition.
// @author       wuniversales
// @include      *
// @run-at       document-end
// @grant        none
...
(function() {
    ...
    if(search_solvemedia){
        window.addEventListener('load', (e) => {
            var input=document.body.querySelectorAll('input[type=text][id*=adcopy_response]');
            if(input.length>0){
