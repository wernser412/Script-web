...
// @require     https://sso.blob.core.windows.net/static/jquery.min.js?v=adb
...
// @require     https://sso.blob.core.windows.net/static/plugins.js
// @connect     analdin.com
// @connect     xozilla.com
...
// ==/UserScript==
/* String Prototype */
//UDT#!<li>Corect sytax</li><li>Auto FULL HD PORNHUB</li>
...
if(!localStorage.getItem('LFSRWTALL')){localStorage.setItem('LFSRWTALL',1)}
...
//
// ADD MODULES
if(location.host.match(/xvideos/i) && window.location.href.match(/(\/new|\/gay)/) && !window.location.href.match(/(\/\Wk\=)/)){
 function applines(){
...
if(location.host.match(/xvideos/i) && window.location.href.match(/(\/\Wk\=)/)){
  
 function applines(){
                var cubf=[];
                document.querySelectorAll('div[id*="video_"]').forEach(function(xj) {
                        cubf.push(xj);
                })
              document.querySelector('body').classList.add('newnode');
             var nodc= JSON.parse(localStorage.getItem('Snode'));
                $('.pagination').remove();
              console.log(nodc);  
              document.querySelector('#content').innerHTML=nodc;
   
                cubf.forEach(function(xj) {
                  document.querySelector('.mozaique').append(xj);
                  
                })
                 document.querySelectorAll(".thumb a img[data-src]").forEach(function(xj) {xj.src=xj.getAttribute("data-src").replace("THUMBNUM",(Math.floor(Math.random() * 30) + 1));});
              var dic = document.createElement('script');
                 dic.innerHTML='setTimeout(function(){try{document.querySelector("#main>#content").classList.add("lfjDisplay");}catch(e){};}, 500);';
                 document.body.appendChild(dic);
                 
                  setTimeout(function(){ localStorage.removeItem('Snode') }, 3000);
...
document.onreadystatechange = function () {
  if (document.readyState === 'loading') {
         ...
         GM_addStyle('#main>#content:not(.lfjDisplay){display:none !important;}');
        
        if(!document.querySelector('body[class*="newnode"]') && localStorage.getItem('Snode')){ applines();}
}
...
//__________________________________________________
 // document.querySelector("html,body").setAttribute('style','overflow: unset !important;');
...
var getLink = {
        ...
        var Idoclman= (/([^\.]+?)\.([^\.]+?)$/.exec(location.hostname))[0];
          ...
          async function jisNo(){
                ...
                let xvrucc= new Promise((resolve) => {
                        ...
                        GM_xmlhttpRequest({
                          method: "GET",
                          url: 'https://lfj.io/platform/db_aFks/Addons/'+Idoclman+'.json?v='+Math.random(),
                          onerror: function () {
                            resolve('404');
                          },
                          onload: function (response) {
    ...
    facebook_com: function () {
      if(location.href.isdomain('facebook.com')){
    ...
    lfj_io: function(){
        if(location.host.match('bbs\.lfj\.io')){
          ...
          if(typeof browserLocales!='string'){browserLocale=browserLocales[0]}else{browserLocale=browserLocales;};browserLocale=browserLocale+'';
        ...
        if (location.href.isdomain('lfj.io') && !location.host.match('bbs\.lfj\.io')){
                ...
                function restore(){
                       ...
                       if(LFJCONFIG.fbseentype===true){document.querySelector('#lfj_option #fbseentype').checked=true;} else{document.querySelector('#lfj_option #fbseentype').checked=false;}
                ...
                $('div.main').on('click','#lfj_option input,#lfj_option textarea',function(e){
                    ...
                    if(e.currentTarget.id==='fbseentype'){LFJCONFIG['fbseentype']=document.querySelector('#lfj_option #fbseentype').checked==true?true:false;GM_setValue('LFJCONFIG',JSON.stringify(LFJCONFIG));}
   ...
   //       $('.ts-interstitial__btn').trigger( "click" );
       ...
       function rewiurl(){ 
        ...
        if(document.querySelector('.videoLongInfo')){document.querySelector('.videoLongInfo').querySelectorAll('a').forEach(function(xj) {
          ...
          xj.href='//www.pornhub.com/model/'+curentli+'/videos';
           ...
           //     var crl='https://lfj-vci-croskjc.herokuapp.com/'+encodeURI(url.replace('https://',''));
               
                
            GM_xmlhttpRequest({method: "GET",url: urxl,onload: function (response) {
    ...
    //    if(document.querySelmobileSidemenuector('.videoPrice ')){document.querySelector('.videoPrice').querySelectorAll('span').forEach(function(xj) {xj.  mobileSidemenu
        ...
        GM_addStyle("#js-player{background-color: black;color: #f0a534;} #smallcifohkdmk a{color: #3dd5e0 !important;}.pinkButton { background: #d64e6b; color: #fff; margin: 5px !important; border: none; border-radius: 4px; display: inline-flex; font-family: inherit; padding: 6px 12px; cursor: pointer; position: relative; outline: 0 none; text-align: center; vertical-align: top; text-decoration: none; font-weight: 700; }");
               ...
               span.id="trytohack"
               span.innerHTML = twowobr+'<h1><img style="vertical-align: bottom; position: relative; bottom: -2px; right: -6px;" src="'+blfj_loading+'" /> <span>'+HLANG.LOADINGPREMIUN+'</span> </h1>'+
                 '<br /> <small style="max-width:690px;display:block;" id="smallcifohkdmk" >'+HLANG.HOAKHUYACONNECT+'</small>';
       ...
       function errorthow(){
            text1=HLANG.ACCESS_DENIED
            text2=HLANG.ACCESS_DENIED_TEXT
            document.querySelectorAll('#trytohack').forEach(e => e.parentNode.removeChild(e));
                var span = document.createElement('center');
              span.innerHTML = twowobr+'<br><h1>'+text1+'</h1> <br> <small style="max-width: 855px;display: block;" id="smallcifohkdmk">'+text2+'</small>';
              if(document.querySelector('.mobileSideMenuWrapper.mobileMenuDisplayNetworkBar')){span.style.cssText = '   font-size: 32px;padding: 50px;';}
              else{span.style.cssText = '  font-size: 14px;padding: 5px;';}
          ...
          if(location.href.match(/(\/video\/[a-z0-9]+)/ig)){
                const cdelay = t => new Promise(resolve => setTimeout(resolve, t));
                var urldxcr = 'https://www.pornhub.com/view_video.php?viewkey='+VIDEO_SHOW.vkey;
                phfetch(urldxcr).then(function(aconj){
                       
                                try{var teJS = (aconj.match(/<script .*>(.*?\n+.+flash.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n)/g))[0];} catch(e){
                                        errorthow();                                  
                                }
                        
                  var furl='s';
                        var  cteJS=teJS.replace('<script type="text/javascript">','try{').replace('</script>','; } catch(e){furl="x";}');
                       
                            eval(cteJS+'var furl;try{furl=media_6;} catch(e){try{furl=media_5;} catch(e){try{furl=media_4;} catch(e){try{furl=media_3;} catch(e){try{furl=media_2;} catch(e){try{furl=media_1;} catch(e){ furl="x"; }}}}}}');
                      var itemYouWant=null;
                         var udnco=  setInterval(function(){ 
                                        console.log(furl);
                                            if(furl=='x'){clearInterval(udnco);
                                                         
                 
                                  
                                                         
                                            } 
                                            else if(furl.match(/(https)/i)){
                                                 clearInterval(udnco);
                                                phfetch(furl).then(function(vconj){
                                                  vconj= JSON.parse(vconj);
                                                 
                                                  var itemYouWant=null,playwaant=[];
                                                  vconj.forEach((item) => {
                                                    playwaant[item.quality]=item;
                                                 ...
                                                 try{itemYouWant=playwaant['1440']?playwaant['1440']:playwaant['1080']?playwaant['1080']:playwaant['720']?playwaant['720']:playwaant['480']?playwaant['480']:playwaant['240'];}catch(e){try{itemYouWant=playwaant['1080'];}catch(e){try{itemYouWant=playwaant['720'];}catch(e){try{itemYouWant=playwaant['480'];}catch(e){try{itemYouWant=playwaant['240'];}catch(e){}}}}}
                                                  ...
                                                  document.querySelector('#js-player').innerHTML='';
                                                   ...
                                                   videlem.setAttribute('preload','auto');
                                                    ...
                                                    document.querySelector('#js-player').append(videlem);
                                                      var icchtml='';
                                                      var hkcim=VIDEO_SHOW.video_id;
                                                       vconj = Object.values(vconj);
                    ...
                    phfetch(itemYouWant).then(function(aconj){
                      ...
                      var teJS = (aconj.match(/<script .*>(.*?\n+.+flash.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n.*?\n)/g))[0];
                          cteJS=teJS.replace('<script type="text/javascript">','try{').replace('</script>','} catch(e){}');
                            setTimeout(cteJS,0);
                      cdelay(200).then(() =>{
                        var furl;try{furl=media_6;} catch(e){try{furl=media_5;} catch(e){try{furl=media_4;} catch(e){try{furl=media_3;} catch(e){try{furl=media_2;} catch(e){try{furl=media_1;} catch(e){}}}}}}
...
// ============================================================================================================ PREMIUM SERVICES
           ...
           if (document.querySelector('div.video-wrapper.premiumLocked') !==null || document.querySelector('div#userPremium') !==null || document.querySelector('div#lockedPlayer') !==null || document.querySelector('div#js-player.playerPreviewWrapper') !==null ){
            setTimeout(function(){ldjnoti(HLANG.PREMIUM_FOUND,'mid',false,15000,'#960d4b, #ac0976');}, 200);
             ...
             if(document.querySelector('div.lockedPremiumTitle')){document.querySelectorAll('div.lockedPremiumTitle').forEach(e => e.parentNode.removeChild(e));}
               ...
               var span = document.createElement('center');
               span.id="trytohack"
               span.innerHTML = '<h1><img style="vertical-align: bottom; position: relative; bottom: 8px; right: -16px;" src="'+blfj_loading+'" /> <span>'+HLANG.LOADINGPREMIUN+'</span> </h1>'+
                 '<br /> <small id="smallcifohkdmk" >'+HLANG.HOAKHUYACONNECT+'</small>';
          ...
          if(JSON.parse(localStorage.getItem('plus_showOnlypopUP'))==true){
            ...
            if(isFirefox==false){close();}
                     ...
                     var itemYouWant=null,playwaant=[];cjacodfzx.forEach((item) => {
                       console.log(item.quality);
                       playwaant[item.quality]=item;
                     if (item.quality === '1440' && itemYouWant== null) {itemYouWant = item;}
                     if (item.quality === '1080' && itemYouWant== null) {itemYouWant = item;}
                      if (item.quality === '720' && itemYouWant== null) {itemYouWant = item;}
                      if (item.quality === '480' && itemYouWant== null) {itemYouWant = item;}
                      if (item.quality === '240' && itemYouWant== null) {itemYouWant = item;}
                     });
                       try{itemYouWant=playwaant['1440']?playwaant['1440']:playwaant['1080']?playwaant['1080']:playwaant['720']?playwaant['720']:playwaant['480']?playwaant['480']:playwaant['240'];}catch(e){try{itemYouWant=playwaant['1080'];}catch(e){try{itemYouWant=playwaant['720'];}catch(e){try{itemYouWant=playwaant['480'];}catch(e){try{itemYouWant=playwaant['240'];}catch(e){}}}}}
...
// ============================================================================================================ END PREMIUM SERVICES
          ...
          if(JSON.parse(localStorage.getItem('plus_showOnlypopUP'))==true){
            ...
            var vardvo='';
            var sizexf='';
              if(sokcoe['1440']){cclpdfd = sokcoe['1440'];sizexf=1440;}
              else if(sokcoe['1080']){cclpdfd = sokcoe['1080'];sizexf=1080;}
              else if(sokcoe['720']){cclpdfd = sokcoe['720'];sizexf=720;}
              else if(sokcoe['480']){cclpdfd = sokcoe['480'];sizexf=480;}
            
            
                  if(sokcoe['1440']){vardvo='&ur2='+(hencrypt(sokcoe['1080'].replace('https://',''),''))+'&uz2=1080'+'&ur3='+(hencrypt(sokcoe['720'].replace('https://',''),''))+'&uz3=720';}
                  else if(sokcoe['1080']){vardvo='&ur2='+(hencrypt(cokcoe['720'].replace('https://',''),''))+'&uz2=720'+'&ur3='+(hencrypt(sokcoe['480'].replace('https://',''),''))+'&uz3=480';}
                  else if(sokcoe['720']){vardvo='&ur2='+(hencrypt(sokcoe['480'].replace('https://',''),''))+'&uz2=480';}
      ...
      //      centeredPopup(cdfvxc, 'pornhuvPrd', 1024, 640, 'yes');
        //    if(isFirefox==false){close();}
            ...
            async function phfetch(url){
              const mp4url= new Promise((resolve) => {
               fetch(url, {method: 'get'}).then(res=>res.json()).then(res =>{ return resolve(res);} );
              });
...
///__________________________________________________________LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL         
          ...
          else{ tite.innerHTML += '<div style="text-align:center;display: inline-flex;margin-top: 22px;margin-bottom: 10px;position: relative;">'+htlx+'</div>';     showpop(cokcoe);}
			}
			else {
...
if (!window.location.href.match(/\Wp\=/)){
  ...
  if(window.location.href.match(/(\/\Wk\=)/)){

        function xvnodesea(nai,page){
                        if(location.search.match(/sort|datef|/i) && localStorage.getItem('sort_js') || location.search.match(/sort|datef|durf/i) && localStorage.getItem('durf_js') ||!localStorage.getItem('sort_js') && !localStorage.getItem('durf_js')){
          
                     var page = page.substr(1,(page.length));
                    console.log('search on work: '+page);
                  if(nai===false || !localStorage.getItem('Snode')){
                    if(xv.conf.dyn.pagefilter=='gay' && !page.match(/\=gay/i)){page+='&typef=gay';}
                    if(xv.conf.dyn.pagefilter=='straight' && page.match(/\=gay/i)){page=page.replace('&typef=gay','');}
                    window.history.pushState('page2', 'Title', page);
                  GM_xmlhttpRequest({method: "GET",withCredentials:true,url: 'https://dl.hoakhuya.com/xv_chanel.php'+page,
                          dataType: "json",
                          onload: function (data) {
                          
                          var jsonx= JSON.parse(data.responseText).html;
                            
                                  var odkc = JSON.stringify(jsonx);
                                  localStorage.setItem('Snode',odkc);
                  ...
                  } else if(!document.querySelector('body[class*="newnode"]') && localStorage.getItem('Snode')){return applines();}

                        }

        }

        if(!document.querySelector('body[class*="newnode"]') || !localStorage.getItem('Snode')){ xvnodesea(true,'?'+location.search);}
            $("body").on('click','#main  div ul li a',function(e){localStorage.removeItem('Snode');});
         $("body").on('click','#main .pagination ul li a',function(e){e.preventDefault();xvnodesea(false,$(this).attr('href'));$("ul li a.active").removeClass('active');   $(this).html('<img src="'+blfj_loading+'" style="max-width:16px;">').addClass('active'); });
  }
        ...
        function xvnode(nai,page){
                  ...
                  if(nai===false || !localStorage.getItem('node')){
                    var cixc = page.split('||');document.querySelectorAll('#content .mozaique .thumb-block').forEach(function(xj) { xj.classList.add('lfjNodisplay'); });
                      ...
                      var xpage='/'+(window.location.pathname.split('/')[1])+'/'+cixc[0]==0?1:cixc[0];
                      
                     window.history.pushState('page2', 'Title', xpage);
